...
import { P as ProtocolError, T as TimeoutWaitingForResponseErrorCode, b as utf8ToBytes, E as ExternalError, M as MissingRootKeyErrorCode, C as Certificate, l as lookupResultToBuffer, R as RequestStatusResponseStatus, U as UnknownError, d as RequestStatusDoneNoReplyErrorCode, e as RejectError, f as CertifiedRejectErrorCode, g as UNREACHABLE_ERROR, I as InputError, h as InvalidReadStateRequestErrorCode, i as ReadRequestType, k as Principal, m as IDL, n as MissingCanisterIdErrorCode, H as HttpAgent, o as encode, Q as QueryResponseStatus, p as UncertifiedRejectErrorCode, q as isV3ResponseBody, s as isV2ResponseBody, t as UncertifiedRejectUpdateErrorCode, v as UnexpectedErrorCode, w as decode, x as Subscribable, y as pendingThenable, z as resolveEnabled, A as shallowEqualObjects, B as resolveStaleTime, D as noop$1, F as environmentManager, G as isValidTimeout, J as timeUntilStale, K as timeoutManager, L as focusManager, N as fetchState, O as replaceData, V as notifyManager, W as hashKey, X as getDefaultState, r as reactExports, Y as shouldThrowError, Z as useQueryClient, $ as useInternetIdentity, a0 as createActorWithConfig, c as createLucideIcon, j as jsxRuntimeExports, a1 as React, a2 as clsx, a as cn, a3 as Record, a4 as Opt, a5 as Service, a6 as Func, a7 as Variant, a8 as Text, a9 as Vec, aa as Int, ab as Float64, ac as Null, ad as React2, ae as reactDomExports, af as ReactDOM } from "./index-CVMDOlA4.js";
...
const ScreenplayId = Text;
const Timestamp = Int;
const Screenplay = Record({
  "id": ScreenplayId,
  "title": Text,
  "content": Text,
  "createdAt": Timestamp,
...
const CharacterVoiceSetting = Record({
  "character": Text,
  "rate": Float64,
  "language": Text,
  "voiceUri": Text,
  "providerType": Opt(Text),
  "pitch": Float64
});
const ScreenplaySummary = Record({
  "id": ScreenplayId,
  "title": Text,
  "createdAt": Timestamp,
  "language": Text
...
Service({
  "addScreenplay": Func(
    [Text, Text, Text],
    [Variant({ "ok": ScreenplayId, "err": Text })],
    []
  ),
  "deleteScreenplay": Func(
    [ScreenplayId],
    [Variant({ "ok": Null, "err": Text })],
    []
  ),
  "getActiveProvider": Func([ScreenplayId], [Text], ["query"]),
  "getScreenplay": Func([ScreenplayId], [Opt(Screenplay)], ["query"]),
  "getVoiceSettings": Func(
    [ScreenplayId],
    [Vec(CharacterVoiceSetting)],
    ["query"]
  ),
  "listScreenplays": Func([], [Vec(ScreenplaySummary)], ["query"]),
  "saveVoiceSettings": Func(
    [ScreenplayId, Vec(CharacterVoiceSetting), Opt(Text)],
    [Variant({ "ok": Null, "err": Text })],
    []
  )
});
const idlFactory = ({ IDL: IDL2 }) => {
  const ScreenplayId2 = IDL2.Text;
  const Timestamp2 = IDL2.Int;
  const Screenplay2 = IDL2.Record({
    "id": ScreenplayId2,
    "title": IDL2.Text,
    "content": IDL2.Text,
  ...
  const CharacterVoiceSetting2 = IDL2.Record({
    "character": IDL2.Text,
    "rate": IDL2.Float64,
    "language": IDL2.Text,
    "voiceUri": IDL2.Text,
    "providerType": IDL2.Opt(IDL2.Text),
    "pitch": IDL2.Float64
  });
  const ScreenplaySummary2 = IDL2.Record({
    "id": ScreenplayId2,
    "title": IDL2.Text,
    "createdAt": Timestamp2,
    "language": IDL2.Text
  ...
  return IDL2.Service({
    "addScreenplay": IDL2.Func(
      [IDL2.Text, IDL2.Text, IDL2.Text],
      [IDL2.Variant({ "ok": ScreenplayId2, "err": IDL2.Text })],
      []
    ),
    "deleteScreenplay": IDL2.Func(
      [ScreenplayId2],
      [IDL2.Variant({ "ok": IDL2.Null, "err": IDL2.Text })],
      []
    ),
    "getActiveProvider": IDL2.Func([ScreenplayId2], [IDL2.Text], ["query"]),
    "getScreenplay": IDL2.Func(
      [ScreenplayId2],
      [IDL2.Opt(Screenplay2)],
      ["query"]
    ),
    "getVoiceSettings": IDL2.Func(
      [ScreenplayId2],
      [IDL2.Vec(CharacterVoiceSetting2)],
      ["query"]
    ),
    "listScreenplays": IDL2.Func([], [IDL2.Vec(ScreenplaySummary2)], ["query"]),
    "saveVoiceSettings": IDL2.Func(
      [ScreenplayId2, IDL2.Vec(CharacterVoiceSetting2), IDL2.Opt(IDL2.Text)],
      [IDL2.Variant({ "ok": IDL2.Null, "err": IDL2.Text })],
      []
    )
  });
...
class Backend {
  ...
  async addScreenplay(arg0, arg1, arg2) {
  ...
  async saveVoiceSettings(arg0, arg1, arg2) {
    if (this.processError) {
      try {
...
function from_candid_CharacterVoiceSetting_n5(_uploadFile, _downloadFile, value) {
...
function to_candid_CharacterVoiceSetting_n9(_uploadFile, _downloadFile, value) {
  return to_candid_record_n10(_uploadFile, _downloadFile, value);
}
function to_candid_opt_n11(_uploadFile, _downloadFile, value) {
...
function to_candid_vec_n8(_uploadFile, _downloadFile, value) {
...
function useGetVoiceSettings(screenplayId) {
  const { actor, isFetching } = useActor();
  return useQuery({
...
export {
  useSaveVoiceSettings as A,
  Badge as B,
  Card as C,
  useId as D,
  useGetScreenplay as E,
  useGetVoiceSettings as F,
  LoaderCircle as L,
  Play as P,
  Select as S,
  CardHeader as a,
  ...
  CardContent as c,
  Button as d,
  useAddScreenplay as e,
  useListScreenplays as f,
  ...
  Primitive as p,
  useComposedRefs as q,
  createCollection as r,
  useDirection as s,
  clamp$1 as t,
  useDeleteScreenplay as u,
  useSize as v,
